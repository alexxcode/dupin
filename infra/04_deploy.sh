...
gcloud run deploy "${SERVICE}" \
  ...
  --set-env-vars="DUPIN_BUNDLE_URI=${BUNDLE_URI},DUPIN_DEMO_FEED_URI=gs://${PROJECT_ID}-artifacts/demo/feed.jsonl,DUPIN_WARM_STATE_URI=gs://${PROJECT_ID}-artifacts/demo/warm_state.json.gz" \
